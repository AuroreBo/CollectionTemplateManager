...
class Ui_global_form(object):
    def setupUi(self, global_form):
        ...
        self.cardtype_checkBox = QtWidgets.QCheckBox(parent=self.scrollAreaWidgetContents)
        self.cardtype_checkBox.setChecked(True)
        self.cardtype_checkBox.setTristate(False)
        self.cardtype_checkBox.setObjectName("cardtype_checkBox")
        self.horizontalLayout_3.addWidget(self.cardtype_checkBox)
    ...
    def retranslateUi(self, global_form):
        ...
        self.cardtype_checkBox.setText(_translate("global_form", "Bright Card ?"))
