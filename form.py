...
class Ui_global_form(object):
    def setupUi(self, global_form):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 552, 1052))
        ...
        self.debug_checkBox = QtWidgets.QCheckBox(parent=self.scrollAreaWidgetContents)
        ...
        self.template_label = QtWidgets.QLabel(parent=self.img_widget)
        self.template_label.setGeometry(QtCore.QRect(-4, 2, 551, 491))
    ...
    def retranslateUi(self, global_form):
        ...
        self.debug_checkBox.setText(_translate("global_form", "Display_debug"))
        ...
        self.template_label.setText(_translate("global_form", "ALLOOOOOOOOOO"))
